...
find . -type f -name "*.md" -print0 | xargs -0 -t sed -i 's|png"><\/p>|png)|g'
find . -type f -name "*.md" -print0 | xargs -0 -t sed -i 's|PNG"><\/p>|PNG)|g'
find . -type f -name "*.md" -print0 | xargs -0 -t sed -i 's|jpg"><\/p>|jpg)|g'
find . -type f -name "*.md" -print0 | xargs -0 -t sed -i 's|JPG"><\/p>|JPG)|g'
...
find . -type f -name "*.md" -print0 | xargs -0 -t sed -i 's|<\/p><\/c>|\n:::|g'
...
find . -type f -name "*.md" -print0 | xargs -0 -t sed -i 's|<\/p>|\n:::|g'
